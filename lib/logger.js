...
class Logger {
  constructor(logPath, appRootPath) {
    this.path = appRootPath ? path.dirname(appRootPath) : undefined;
  ...
  error(...args) {
    ...
    this.write('error', this.path ? msg.replaceAll(this.path, '') : msg);
  }
...
module.exports = (logPath, appRootPath) =>
  Object.freeze(new Logger(logPath, appRootPath));
